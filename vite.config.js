...
const CSP_DIRECTIVE =
	"default-src 'self'; script-src 'self' 'sha256-tVXT1HJKyqaO3OBFEhZPvsUwx8Wqc62KBuqhKe3n+Ko='; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; connect-src 'self' https://api.yuzuki.space http://localhost:5000 http://127.0.0.1:5000 ws: wss:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-src 'self'";
